...
import app.nanodegree.masini.simone.sunshine.data.WeatherContract.WeatherEntry;

/**
 * Package: app.nanodegree.masini.simone.sunshine
 * Project: Sunshine
 * Created by Simone Masini on 18/06/2015 at 19.12.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor!=null && locationCursor.moveToFirst()){
            ...
            cv.put(WeatherContract.LocationEntry.COLUMN_LATITUDE, lat);
            cv.put(WeatherContract.LocationEntry.COLUMN_LONGITUDE, lon);
