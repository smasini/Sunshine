package app.nanodegree.masini.simone.sunshine.sync;
...
import app.nanodegree.masini.simone.sunshine.MainActivity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    @IntDef({
            LOCATION_STATUS_OK, LOCATION_STATUS_SERVER_DOWN, LOCATION_STATUS_SERVER_INVALID,  LOCATION_STATUS_UNKNOWN, LOCATION_STATUS_INVALID
    })
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String API_KEY_PARAMS = "APPID";
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(API_KEY_PARAMS, getContext().getString(R.string.open_weather_api_key))
                    .build();
    ...
    private void notifyWeather() {
        ...
        boolean displayNotifications = prefs.getBoolean(context.getString(R.string.pref_enable_notifications_key), false);
